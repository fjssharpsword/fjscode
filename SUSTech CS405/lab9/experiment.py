...
class GMM(object):
    ...
    def updata(self, datas, beliefs):#M-Step
...
def experiment():
    ...
    ncomp = int(3)#the number of classes
    ...
    #use EM algorithm to update the parameters of GMM
    prev_log_likelihood = None
    for i in range(1000):
        beliefs, log_likelihood = gmm.inference(image_pixels)#E step
        gmm.updata(image_pixels, beliefs)#M step
    ...
    segmented_map = np.zeros((image_height, image_width,ncomp))
